  ...
  return (
    <main className="max-w-[1240px] mx-auto px-4 md:px-[22px] py-10">
      <div className="legal">
        ...
        <p className="lead">
          本サービス（D-market）は、ポイントを金銭で販売しておらず、利用者から金銭の支払いを受けるものではありません。本表記は、景品の提供に関する事項の透明性のために掲載するものです。
        </p>
        ...
        <h2>料金・支払いについて</h2>
        <ul>
          <li><strong>ポイントの販売価格</strong>：ポイントは無償で発行され、販売していません（購入できません）。</li>
          <li><strong>景品交換に要する金銭</strong>：景品は、利用者が無償で取得したポイントとの交換で提供され、金銭のお支払いは不要です。</li>
        ...
        <h2>交換のキャンセル・返品</h2>
        <p>景品交換は確定交換のため、申込確定後の利用者都合によるキャンセル・返品・ポイントの返還はできません。景品に当社の責に帰すべき不良があった場合は、個別に対応します。</p>
