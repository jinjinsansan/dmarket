...
| 0009 | pg_cron スケジュール（供給15分/解決5分）※リモート専用 | 03/04 | Phase 3-4 | ✅(remote) |
| 0010 | リーダーボード（user_stats/seasons/season_scores/badges/user_badges） | 06 | Phase 6 | 予定 |
| 0011 | 管理（admin_users/profiles/admin_audit）＋管理RPC | 01/07 | Phase 1/7 | 予定 |
| 0012 | マネタイズ・不正（entitlements/account_signals/fraud_flags） | 08 | Phase 8 | 予定 |
