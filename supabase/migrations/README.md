...
| 0007 | 供給（category_feed_settings/market_templates/poly_mirror_cache）＋ resolution_audit | 03/04 | Phase 3-4 | 予定 |
| 0008 | リーダーボード（user_stats/seasons/season_scores/badges/user_badges） | 06 | Phase 6 | 予定 |
| 0009 | 管理（admin_users/profiles/admin_audit）＋管理RPC | 01/07 | Phase 1/7 | 予定 |
| 0010 | マネタイズ・不正（entitlements/account_signals/fraud_flags） | 08 | Phase 8 | 予定 |
